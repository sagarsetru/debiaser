...
for n_topics in n_topics_test:
    ...
    lda_top_topic_words_list, lda_top_topic_words_string, lda_topics = return_suggested_articles2(url,num_lda_topics=n_topics,use_pre_trained_model=0,n_passes=10,do_ngrams=1)
